package com.shinelon.rxjavalearn.javademo;
...
import com.shinelon.rxjavalearn.R;
        ...
        api.getSomeThing(url)
                ...
                .subscribe(new Consumer<BaseResponse>() {
                    ...
                    public void accept(BaseResponse baseResponse) throws Exception {
                        Toast.makeText(Main2Activity.this, baseResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
